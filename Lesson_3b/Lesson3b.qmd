...
Here, I load the baby names data set from lesson 3, but including all existing names, and assign it to `data_usa`.
...
For an ANOVA, you need your data in a wide format, that is, a separate column for Austria and the US and this for each sex.
