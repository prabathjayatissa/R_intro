...
Download this [data file](www.hannahmetzler.eu/R_intro/Lesson_2/data/pets.csv) from the course website and put it into the data folder. We'll be writing a script to analyse it during today's session. If needed, you can also download it [here](https://github.com/hannahmetzler/R_intro_lesson2/blob/main/code/rintro_lesson2.R). 
:::
...
Write down and run this code. You can use these keyboard shortcuts:
  ...
  - Keyboard shortcut:`%>%` pipe: `Shift + Ctrl + M` or
