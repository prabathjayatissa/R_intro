...
To run a linear regression, our dependent variable needs to be normally distributed. A perfect normal distribution is symmetrical, for example:
...
Let's check this with a histogram:
