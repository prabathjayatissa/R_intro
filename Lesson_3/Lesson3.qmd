...
We may want to change names or levels of variables a bit for our figures. It's good to create an extra dataset for this: 
...
To run a linear regression, our dependent variable needs to be normally distributed. Let's check this with a histogram:
...
name.plot
```
- Proportion of babies with the name "Page" is not normally distributed. 
