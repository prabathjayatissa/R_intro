...
- We get a significant effect of sex: t = `r round(sex.lm_sum$coefficients[2,3], 2)`, p = `round(sex.lm_sum$coefficients[2,4], 3)`. 
...
<pre><code class="r">
&#96;&#96;&#96;{r, echo=F}
load('write_up/lesson3_environment.RData')
&#96;&#96;&#96;
</code></pre>

- Add `echo = FALSE` in the curly brackets after r: ````{r, echo = FALSE}`. This let's R know you do not want to print out (echo) the code in the report, but only its results. 
- Now add sections to your report, for example: 

1) Introduction
2) Results
    1) Prevalence by Year
    2) Prevalence by Sex
3) Conclusions
